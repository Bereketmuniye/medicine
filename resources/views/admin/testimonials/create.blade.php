...
<x-admin.card-header 
    ...
    subtitle="Add a new client testimonial or review."
>
    <x-slot name="action">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            <label for="featured_image" class="form-label fw-semibold">Upload Photo</label>
            ...
            <div class="border-top pt-4">
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary rounded-pill px-4">
                        <i class="fa-solid fa-save me-2"></i>Create Testimonial
                    </button>
                </div>
            </div>
        </form>
